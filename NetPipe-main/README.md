...
- `HandshakeMessage.java` is a class with methods and declarations for the message exchange between client and server during the handshakeProcess phase. Use it to implement the handshakeProcess protocol. (It is *not* used by any of other classes, since they do not support security.)
